  ...
  return (
    <section className="space-y-6">
      <div className="rounded-[32px] bg-white p-8 shadow-sm ring-1 ring-slate-200/80">
        ...
        <h1 className="mt-4 text-3xl font-semibold text-slate-900">Response Time</h1>
        <p className="mt-2 text-slate-500">Placeholder page for Response Time in the Operational Portal.</p>
      </div>
    </section>
  );
}
