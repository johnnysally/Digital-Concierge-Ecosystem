            ...
            <div className="mx-auto flex max-w-6xl flex-col overflow-hidden rounded-[28px] border border-slate-200 bg-white/95 shadow-[0_20px_60px_-25px_rgba(15,23,42,0.25)] backdrop-blur-xl sm:rounded-[32px] lg:flex-row">
                <div className="flex flex-1 flex-col justify-between bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.18),_transparent_30%),linear-gradient(135deg,_#fff7ed,_#fef3c7)] p-4 sm:p-8 lg:p-12">
                    <div className="flex items-center justify-between lg:hidden">
                        ...
                        <span className="text-xs uppercase tracking-[0.25em] text-slate-500">Create account</span>
                    </div>
                    ...
                    <div>
                        ...
                        <h1 className="mt-6 text-2xl font-semibold tracking-tight text-slate-900 sm:mt-8 sm:text-4xl">Create your premium travel account</h1>
                        <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600 sm:mt-4 sm:text-base sm:leading-7">Join a unified platform for booking stays, ordering dining, arranging transport, and managing rewards effortlessly.</p>
                    </div>
                ...
                <div className="flex-1 p-4 sm:p-8 lg:p-12">
                    <div className="mx-auto max-w-md">
                        ...
                        <div className="mt-6 text-center text-sm text-slate-500">
                            Already have an account? <Link to="/login" className="font-semibold text-amber-600 hover:text-amber-500">Sign in</Link>
                        </div>
                    </div>
                </div>
            </div>
