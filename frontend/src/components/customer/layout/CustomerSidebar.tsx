...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Browse Hotels", path: "/customer/search/hotels", icon: "🏨" },
      { label: "Browse BnBs", path: "/customer/search/bnbs", icon: "🏘️" },
            ...
            <div key={g.title} className="space-y-2">
              ...
              <div className="space-y-1">
                {g.items.map((item) => (
                  ...
                  >
                    <span className={`flex h-8 w-8 items-center justify-center rounded-lg text-sm shadow-sm ${isDark ? "bg-slate-800 text-slate-200" : "bg-gray-50 text-slate-700"}`}>{item.icon}</span>
