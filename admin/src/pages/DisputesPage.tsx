        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-2 flex-wrap overflow-x-auto pb-2">
                <button onClick={() => setActiveTab('disputes')}
                    className={`min-w-[10rem] whitespace-nowrap rounded-xl px-4 py-2 text-sm font-medium transition-colors ${activeTab === 'disputes' ? 'bg-primary-500 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>
                    ⚖️ Disputes ({totalDisputes})
                </button>
                <button onClick={() => setActiveTab('tickets')}
                    className={`min-w-[10rem] whitespace-nowrap rounded-xl px-4 py-2 text-sm font-medium transition-colors ${activeTab === 'tickets' ? 'bg-primary-500 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>
